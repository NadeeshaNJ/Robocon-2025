...
// right mortor
#define IN1 25    // Direction pin 1
#define IN2 33    // Direction pin 2
#define ENA 32    // PWM speed control pin
// left mortor
#define IN3 26   // Direction pin 1
#define IN4 27    // Direction pin 2
#define ENB 14    // PWM speed control pin
